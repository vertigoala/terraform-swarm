...
#        'tags.Ami'
    ...
    for k in resources:
        if k['type'] == 'aws_lightsail_instance': # 'aws_instance':
...
#        'tags.Ami'
    ...
    for instance in instances:
        name = instance['public_ip_address'] # public_ip 
        for attr in grouping_attrs:
            if attr in instance:
                ...
                if group:
                    ...
                    inventory[group]['vars'] = {"ansible_user": "ubuntu", "ansible_python_interpreter": "/usr/bin/python3"}
